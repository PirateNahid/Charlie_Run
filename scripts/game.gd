...
func generate_obs():
	if obstacles.is_empty() or last_obs.position.x < score + randi_range(300,500):
		...
		var obs_x : int = screen_size.x + score + score/500 + randi_range(0,500)
...
func check_high_score():
	...
	if score > high_score:
		...
		var name_file = FileAccess.open("user://save_name.dat", FileAccess.READ)
		await Leaderboards.post_guest_score("charlie-runn-main-SgU7", score/10 , name_file.get_var())
...
func load_score():
	...
	print("Loaded Score: " + str(content))
	return content
